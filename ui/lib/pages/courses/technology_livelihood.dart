              ...
              children: [
                ...
                TextButton.icon(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => const QuizPage(courseId: 3, category: 'General')),
                    );
                  },
              ...
              children: [
                ...
                TextButton.icon(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => const QuizPage(courseId: 3, category: 'Professional')),
                    );
                  },
                  icon: const Icon(Icons.chevron_right),
                  label: const Text(''),
              ...
              children: [
                ...
                TextButton.icon(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => const QuizPage(courseId: 3, category: 'Specialization')),
                    );
                  },
                  icon: const Icon(Icons.chevron_right),
                  label: const Text(''),
