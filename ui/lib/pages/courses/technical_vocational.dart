              ...
              children: [
                ...
                TextButton.icon(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => const QuizPage(courseId: 2, category: 'General')),
                    );
                  },
              ...
              children: [
                ...
                TextButton.icon(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => const QuizPage(courseId: 2, category: 'Professional')),
                    );
                  },
                  icon: const Icon(Icons.chevron_right),
                  label: const Text(''),
              ...
              children: [
                ...
                TextButton.icon(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => const QuizPage(courseId: 2, category: 'Specialization')),
                    );
                  },
                  icon: const Icon(Icons.chevron_right),
                  label: const Text(''),
